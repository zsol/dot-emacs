...
(custom-theme-set-faces
 ...
 '(helm-grep-match ((t (:inherit match :background "darkblue"))))
 '(helm-selection ((t (:background "ForestGreen" :foreground "black" :underline t))))
 '(helm-selection-line ((t (:background "darkred" :underline t))))
 '(font-lock-builtin-face ((t (:foreground "PaleTurquoise4"))))
 ...
 '(custom-face-tag ((t (:bold t :family "helv" :weight bold :height 1.1))))
 '(custom-group-tag ((t (:bold t :family "helv" :foreground "light blue" :weight bold :height 1.1))))
 '(custom-group-tag-1 ((t (:bold t :family "helv" :foreground "pink" :weight bold :height 1.1))))
 ...
 '(custom-variable-button ((t (:bold t :underline t :weight bold :background "lightgrey" :foreground "black" :box (quote (:line-width 2 :style released-button))))))
 ...
 '(default ((t (:background "black" :foreground "dark gray")))))
